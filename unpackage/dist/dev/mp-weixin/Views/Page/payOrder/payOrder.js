  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        q: common_vendor.sr(popup, "a0cae330-0", {
          "k": "popup"
        }),
        ...
        v: common_vendor.sr(change, "a0cae330-2", {
          "k": "change"
        }),
        ...
        y: common_vendor.sr(alertDialog, "a0cae330-4", {
          "k": "alertDialog"
        }),
        z: common_vendor.p({
          type: "dialog"
        ...
        B: common_vendor.sr(cAlertDialog, "a0cae330-6", {
          "k": "cAlertDialog"
        }),
        C: common_vendor.p({
          type: "dialog"
        }),
        D: common_vendor.sr(success, "a0cae330-8", {
          "k": "success"
        }),
        E: common_vendor.p({
          type: "dialog"
