      ...
      return {
        ...
        w: common_vendor.f(publishInfo.value, (item, index, i0) => {
          ...
          return {
            ...
            d: common_vendor.o(($event) => jumpToComments(item), index),
            e: common_vendor.t(item.title),
            f: common_vendor.t(item.content),
            g: item.url,
            h: common_vendor.o(($event) => jumpToComments(item), index),
            i: common_vendor.t(item.transfer),
            j: (_a = isUpvoteList.value) == null ? void 0 : _a[index],
            k: common_vendor.t(item.upvote),
            l: common_vendor.o(($event) => upvote(item.id, 0), index),
            m: common_vendor.t(item.pls),
            n: common_vendor.o(($event) => jump(item), index),
            o: index
          };
        }),
