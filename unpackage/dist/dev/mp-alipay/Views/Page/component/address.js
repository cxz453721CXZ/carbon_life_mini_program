      ...
      return {
        ...
        c: common_vendor.f(addressList.value, (item, index, i0) => {
          return {
            ...
            e: common_vendor.o(($event) => del(item.id)),
            f: common_vendor.o(($event) => edit(item)),
            g: index
          };
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-8b675b53"], ["__file", "D:/Web前端小程序/备份/carbon-life/Carbon-Life/Views/Page/component/address.vue"]]);
