      ...
      return {
        ...
        b: common_vendor.f(items.value, (item, index, i0) => {
          return {
            ...
            h: item.src,
            i: index,
            j: common_vendor.o(($event) => jump(index))
          };
        }),
        c: common_vendor.f(items_1.value, (item, index, i0) => {
          return {
            ...
            h: item.src,
            i: index,
            j: common_vendor.o(($event) => jump(index + 3))
          };
        }),
        ...
        g: common_vendor.o(jumpToDetail),
        h: common_vendor.f(items_3.value, (item, index, i0) => {
          return {
            a: index
          };
        }),
        i: common_vendor.unref(common_global.GreenChallenageImgUrl) + "index/huodong2.png",
        j: common_vendor.unref(common_global.GreenChallenageImgUrl) + "index/liulanliang.png"
      };
    };
  }
});
