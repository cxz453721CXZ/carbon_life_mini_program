      ...
      return {
        ...
        h: common_vendor.f(firstComments.value, (item, index, i0) => {
          ...
          return {
            ...
            h: common_vendor.o(($event) => upvote(item.fid, 1)),
            i: common_vendor.t(item.pls),
            j: common_vendor.o(($event) => setMessage(item.fid, item.userName)),
            k: common_vendor.f(item.secondCommentsDetails, (it, idx, i1) => {
              return {
                ...
                h: common_vendor.o(($event) => setSecondMessage(item.fid, it.sid, it.userName)),
                i: idx
              };
            }),
            l: index
