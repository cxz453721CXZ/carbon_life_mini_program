...
const uni_modules_uniFilePicker3_components_uniFilePicker3_chooseAndUploadFile = require("./choose-and-upload-file.js");
const uni_modules_uniFilePicker3_components_uniFilePicker3_utils = require("./utils.js");
...
const _sfc_main = {
  ...
  created() {
    if (!(common_vendor.Ws.config && common_vendor.Ws.config.provider)) {
      this.noSpace = true;
      common_vendor.Ws.chooseAndUploadFile = uni_modules_uniFilePicker3_components_uniFilePicker3_chooseAndUploadFile.chooseAndUploadFile;
    }
  ...
  methods: {
     ...
     */
    chooseFiles() {
      const _extname = uni_modules_uniFilePicker3_components_uniFilePicker3_utils.get_extname(this.fileExtname);
    ...
    async chooseFileCallback(res) {
      ...
      let {
        filePaths,
        files
      } = uni_modules_uniFilePicker3_components_uniFilePicker3_utils.get_files_and_is_max(res, _extname);
      ...
      for (let i = 0; i < files.length; i++) {
        ...
        let filedata = await uni_modules_uniFilePicker3_components_uniFilePicker3_utils.get_file_data(files[i], this.fileMediatype);
        filedata.progress = 0;
    ...
    uploadFiles(files) {
      files = [].concat(files);
      return uni_modules_uniFilePicker3_components_uniFilePicker3_chooseAndUploadFile.uploadCloudFiles.call(this, files, 5, (res) => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Web前端小程序/备份/carbon-life/Carbon-Life/uni_modules/uni-file-picker3/components/uni-file-picker3/uni-file-picker3.vue"]]);
