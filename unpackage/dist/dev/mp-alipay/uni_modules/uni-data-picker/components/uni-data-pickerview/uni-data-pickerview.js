  ...
  return common_vendor.e({
    ...
    b: common_vendor.f(_ctx.selected, (item, index, i0) => {
      return common_vendor.e({
        ...
        b: common_vendor.t(item.value !== null ? item.text : "选择省")
      } : index === 1 ? {
        d: common_vendor.t(item.value !== null ? item.text : "选择市")
      } : {
        e: common_vendor.t(item.value !== null ? item.text : "选择区")
      }, {
        c: index === 1,
        f: index,
        g: index == _ctx.selectedIndex ? 1 : "",
        h: common_vendor.o(($event) => $options.handleSelect(index))
      });
    })
  } : {}, {
    c: common_vendor.f(_ctx.dataList[_ctx.selectedIndex], (item, j, i0) => {
      return common_vendor.e({
        ...
        c: !!item.disable ? 1 : "",
        d: j,
        e: common_vendor.o(($event) => $options.handleNodeClick(item, _ctx.selectedIndex, j))
      });
    }),
    d: _ctx.loading
  }, _ctx.loading ? {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/Web前端小程序/备份/carbon-life/Carbon-Life/uni_modules/uni-data-picker/components/uni-data-pickerview/uni-data-pickerview.vue"]]);
