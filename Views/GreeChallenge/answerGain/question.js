...
[
  {
    ...
    correctResponse:'B', //正确答案
	zq: 1, //正确答案索引0, 1, 2, 3分别对应A, B, C, D
   anwerDescription: '解释说明：低碳出行强调的是减少碳排放和能源消耗，通过选择低能耗、低排放的交通方式来实现。骑自行车或步行代替汽车短途出行是典型的低碳出行方式，能够显著减少碳排放。', //答案描述
  },
  { 
